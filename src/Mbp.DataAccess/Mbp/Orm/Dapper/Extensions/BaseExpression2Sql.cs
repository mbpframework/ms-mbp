...
namespace WuhanIns.Nitrogen.Orm.Dapper.Extensions.Expression2Sql
{
	public abstract class BaseExpression2Sql<T> : IExpression2Sql where T : Expression
	{
		...
		protected virtual SqlPack OrderByDescending(T expression, SqlPack sqlPack)
		{
		...
		public SqlPack OrderByDescending(Expression expression, SqlPack sqlPack)
		{
			return OrderByDescending((T)expression, sqlPack);
		}
